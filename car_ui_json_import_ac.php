...
<? if(!$upload) { ?>
<br/>
<form action=".?page=car_ui_json_import_ac" method="post" enctype="multipart/form-data">
...
<form action="car_add_do.php" method="post">
      ...
      <td width="100">Sim:</td>
    	<td>
			...
			<tr><td>Brand:</td>
        <td><input type="text" name="brand" value= "<?echo $brand;?>" size="20" maxlength="20"></td></tr>
			<tr><td>Name:</td>
        <td><input type="text" name="name" value= "<?echo $name;?>" size="20" maxlength="20"></td></tr>
      <tr>
