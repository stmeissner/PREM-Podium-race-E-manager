...
$query = "UPDATE season SET name='$name', division='$division', ruleset='$ruleset', ruleset_qualifying='$ruleset_qualifying',
														maxteams='$maxteams', series_logo_simresults='$series_logo_simresults', prov_quantity='$prov_quantity'
												WHERE id='$id'";
$result = mysqli_query($link,$query);
if(!$result) error("MySQL Error: " . mysqli_error($link) . "\n");
