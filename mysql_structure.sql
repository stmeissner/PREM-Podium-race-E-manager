...
--
-- Host: localhost
-- Erstellungszeit: 20. Jan 2018 um 18:12
...
CREATE TABLE `race_driver` (
  ...
  `ballast` smallint(3) NOT NULL,
  `restrictor` tinyint(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
