...
<table class="w3-table-all">
	<tr>
	  <td width="100">Sim:</td>
		<td>
			<select name="sim">
				  <option value="<?echo $item['sim'];?>">Press F5</option>
					<option value="ac">Assetto Corsa</option>
					<option value="lfs">Life for Speed</option>
					<option value="rf">rFactor</option>
					<option value="rf2">rFactor2</option>
		</select>
	  </td>
	</tr>
	...
	<tr>
	  <td width="120">Badge:</td>
		<td>
			<select name="badge">
				<option value="<?echo $item['badge'];?>">Press F5</option>
	...
	<tr>
		...
		<td>
			<select name="brand">
				  <option value="<?echo $item['brand']?>">Press F5</option>
...
<tr>
	<td width="120">CarModel:</td>
	<td><input type="text" name="name" value="<?echo $item['name']?>" maxlength="30"></td>
</tr>
<tr>
	<td width="100">Simcode:</td>
	<td>
		<select name="code">
			<option value="<?echo $item['code'];?>">Press F5</option>
...
<tr>
	...
	<td><input type="text" name="horsepower" value = "<?echo $item['horsepower'];?>" maxlength="10"></td>
</tr>
<tr>
	<td width="120">Torque:</td>
	<td><input type="text" name="torque" value = "<?echo $item['torque'];?>" maxlength="10"></td>
</tr>
<tr>
